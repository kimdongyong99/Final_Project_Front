...
async function displayLikedPosts() {
    ...
    if (access_token && username) {
        try {
            ...
            const response = await fetch(`https://3.38.95.210/api/posts/${username}/liked_posts`, {
                method: "GET",
                headers: {
...
async function displayLikedArticles() {
    ...
    if (access_token && username) {
        try {
            ...
            const response = await fetch(`https://3.38.95.210/api/articles/${username}/liked_articles`, {
                method: "GET",
                headers: {
                    "Authorization": `Bearer ${access_token}` // 토큰 필요 시 사용
                }
...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    if (access_token) {
        ...
        await fetch(`https://3.38.95.210/api/posts/?author=${username}`, {
            method: "GET",
            headers: {
