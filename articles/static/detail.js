document.addEventListener("DOMContentLoaded", async function () {
    ...
    async function fetchArticle() {
        try {
            const response = await fetch(`https://afitday.shop/api/articles/${articleId}/`);
            if (response.ok) {
    ...
    async function fetchComments() {
        ...
        try {
            const response = await fetch(`https://afitday.shop/api/articles/${articleId}/comments/`);
            if (response.ok) {
    ...
    window.submitEditComment = async function(commentId) {
        ...
        try {
            const response = await fetch(`https://afitday.shop/api/articles/comments/${commentId}/`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
