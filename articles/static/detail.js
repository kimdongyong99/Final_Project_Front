document.addEventListener("DOMContentLoaded", async function () {
    ...
    async function fetchArticle() {
        try {
            const response = await fetch(`https://3.38.95.210/api/articles/${articleId}/`);
            if (response.ok) {
    ...
    async function fetchComments() {
        ...
        try {
            const response = await fetch(`https://3.38.95.210/api/articles/${articleId}/comments/`);
            if (response.ok) {
    ...
    window.submitEditComment = async function(commentId) {
        ...
        try {
            const response = await fetch(`https://3.38.95.210/api/articles/comments/${commentId}/`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
