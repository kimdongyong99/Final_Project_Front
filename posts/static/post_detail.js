document.addEventListener("DOMContentLoaded", function () {
    ...
    const postUrl = `https://afitday.shop/api/posts/${postId}/`;
    ...
    fetch(postUrl)
        ...
        .then(data => {
            ...
            if (data.image) {
                const imageUrl = `https://afitday.shop${data.image}`;  // 서버 URL에 /media 경로 추가
    ...
    document.getElementById('comment-form').addEventListener('submit', function (e) {
        ...
        fetch(`https://afitday.shop/api/posts/${postId}/comment/`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`  // JWT 토큰 추가
    ...
    function editComment(commentId, newContent) {
        const editUrl = `https://afitday.shop/api/posts/comment/${commentId}`;  // URL에 commentId 추가
    ...
    function deleteComment(commentId) {
        const deleteUrl = `https://afitday.shop/api/posts/comment/${commentId}`;  // URL에 commentId 추가
